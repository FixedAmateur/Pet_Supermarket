...
DROP TABLE IF EXISTS `prod_discount`;
...
LOCK TABLES `prod_discount` WRITE;
/*!40000 ALTER TABLE `prod_discount` DISABLE KEYS */;
/*!40000 ALTER TABLE `prod_discount` ENABLE KEYS */;
UNLOCK TABLES;
